...
while executando:
    ...
    if proximo_a_parede:
        # Calcule as coordenadas do quadrado reflexo
        x_reflexo = 2 * x_parede + largura_parede - x_quadrado
        y_reflexo = y_quadrado
        pygame.draw.rect(tela, cor_quadrado_reflexo, (x_reflexo - lado_quadrado / 2, y_reflexo - lado_quadrado / 2, lado_quadrado, lado_quadrado))

    # Desenhe a linha diagonal no centro do quadrado
    pygame.draw.line(tela, (0, 0, 0), (x_quadrado - lado_quadrado / 2, y_quadrado - lado_quadrado / 2), (x_quadrado + lado_quadrado / 2, y_quadrado + lado_quadrado / 2))
